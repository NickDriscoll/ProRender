...
int main(int argc, char* argv[]) {
	...
	while (running) {
		...
		//Draw
		{
			...
			vkCmdBindPipeline(current_cb, VK_PIPELINE_BIND_POINT_GRAPHICS, graphics_pipelines[0].pipeline);
	...
	vkDestroyPipeline(vgd.device, graphics_pipelines[0].pipeline, vgd.alloc_callbacks);
